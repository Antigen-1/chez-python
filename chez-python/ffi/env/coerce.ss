...
(library (chez-python ffi env coerce)
  (export ->py-int ->scm-int ->py-double ->scm-double
	  ->py-string ->scm-string
	  ->py-list ->py-tuple ->scm-list ->scm-vector
	  make-empty-py-dict
	  ->py-datum ->scm-datum)
  (import (chezscheme) (chez-python exn) (chez-python ffi env api)
	  (chez-python ffi helper) (chez-python ffi utility))

  (define env (environment '(chez-python ffi env api)))
